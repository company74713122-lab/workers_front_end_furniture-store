...
export default function SEO({
  ...
  const defaultTitle = title || 'العباسي - أثاث منزلي فاخر | معرض الأثاث الراقي في مصر';
  const defaultDescription = description || 'اكتشف أفخم قطع الأثاث المنزلي في العباسي. غرف معيشة، نوم، سفرة، ومكاتب بأعلى جودة وأفضل الأسعار. توصيل مجاني وضمان 5 سنوات.';
  const defaultKeywords = keywords || 'أثاث منزلي, أثاث فاخر, معرض أثاث, العباسي , غرف معيشة, غرف نوم, أثاث مصر, أثاث راقي';
